...
[`.github/copilot-instructions.md`](.github/copilot-instructions.md), including the
comment philosophy, TSDoc/JSDoc requirements, Astro component contracts, and
TypeScript formatting conventions. Path-specific guidance is in
